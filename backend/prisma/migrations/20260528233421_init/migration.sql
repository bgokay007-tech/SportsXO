...
CREATE TABLE "AthleteCard" (
    ...
    CONSTRAINT "AthleteCard_pkey" PRIMARY KEY ("id")
);
...
-- AddForeignKey
ALTER TABLE "Skill" ADD CONSTRAINT "Skill_profileId_fkey" FOREIGN KEY ("profileId") REFERENCES "AthleteProfile"("id") ON DELETE CASCADE ON UPDATE CASCADE;

-- AddForeignKey
ALTER TABLE "AthleteCard" ADD CONSTRAINT "AthleteCard_userId_fkey" FOREIGN KEY ("userId") REFERENCES "User"("id") ON DELETE CASCADE ON UPDATE CASCADE;
